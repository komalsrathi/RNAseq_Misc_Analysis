#!/bin/bash
# this program works on .BAM files
...
# picard: java -Xmx2g -jar DownsampleSam.jar PROBABILITY=1 INPUT=/home/krathi/outputtemp OUTPUT=/home/krathi/output_shuffle.sam
